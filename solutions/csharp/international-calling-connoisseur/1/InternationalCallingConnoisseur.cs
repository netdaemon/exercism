...
public static class DialingCodes
{
    ...
    public static string FindLongestCountryName(Dictionary<int, string> existingDictionary) => existingDictionary.Values.Aggregate("", (max, curr) => max.Length > curr.Length ? max : curr);
}